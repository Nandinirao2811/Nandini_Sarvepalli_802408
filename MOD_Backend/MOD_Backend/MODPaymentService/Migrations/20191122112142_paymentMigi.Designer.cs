...
namespace MODPaymentService.Migrations
{
    ...
    [Migration("20191122112142_paymentMigi")]
    partial class paymentMigi
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MODPaymentService.Models.Mentor", b =>
                {
            ...
            modelBuilder.Entity("MODPaymentService.Models.Payment", b =>
                {
            ...
            modelBuilder.Entity("MODPaymentService.Models.Technology", b =>
                {
            ...
            modelBuilder.Entity("MODPaymentService.Models.Training", b =>
                {
            ...
            modelBuilder.Entity("MODPaymentService.Models.User", b =>
                {
                    b.Property<int>("User_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MODPaymentService.Models.Payment", b =>
                {
                    b.HasOne("MODPaymentService.Models.Mentor", "Mentor")
                        .WithMany("Payments")
                        .HasForeignKey("Mentor_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MODPaymentService.Models.User", "User")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("MODPaymentService.Models.Training", b =>
                {
                    ...
                    b.HasOne("MODPaymentService.Models.Technology", "Technology")
                        .WithMany("Trainings")
