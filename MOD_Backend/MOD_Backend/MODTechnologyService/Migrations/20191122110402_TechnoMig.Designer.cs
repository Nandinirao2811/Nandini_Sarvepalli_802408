...
namespace MODTechnologyService.Migrations
{
    ...
    [Migration("20191122110402_TechnoMig")]
    partial class TechnoMig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MODTechnologyService.Models.Mentor", b =>
                {
            ...
            modelBuilder.Entity("MODTechnologyService.Models.Payment", b =>
                {
            ...
            modelBuilder.Entity("MODTechnologyService.Models.Technology", b =>
                {
            ...
            modelBuilder.Entity("MODTechnologyService.Models.Training", b =>
                {
            ...
            modelBuilder.Entity("MODTechnologyService.Models.User", b =>
                {
                    b.Property<int>("User_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MODTechnologyService.Models.Payment", b =>
                {
                    b.HasOne("MODTechnologyService.Models.Mentor", "Mentor")
                        .WithMany("Payments")
                        .HasForeignKey("Mentor_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MODTechnologyService.Models.User", "User")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("MODTechnologyService.Models.Training", b =>
                {
                    ...
                    b.HasOne("MODTechnologyService.Models.Technology", "Technology")
                        .WithMany("Trainings")
